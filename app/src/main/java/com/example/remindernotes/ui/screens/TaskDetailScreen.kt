...
@Composable
fun TaskDetailScreen(navController: NavController, taskViewModel: TaskViewModel) {
    ...
    Scaffold(
        ...
        content = { paddingValues -> // Pass the padding values from Scaffold
            Column(modifier = Modifier.padding(paddingValues).padding(16.dp)) { // Use both paddings
                OutlinedTextField(
                    value = title,
